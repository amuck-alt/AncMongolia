								...
								<table class="mt-1 table-bordered">
									...
									<tr>
										...
										<td width="25%" colspan="3" class="px-2 py-2">
											...
											<select class="form-control col-4 ml-2 input-group-append" name="regsection" id="regsection" style="height:30px;padding:0.3rem;" required>
									...
									<tr>
										...
										<td width="25%" class="px-2 py-2">
											<select class="form-control col-12" name="status" id="status" style="height:30px;padding:0.3rem;background-color:#d7f8fc;">
												...
												<option value="hold" <c:if test="${result.status eq 'hold'}">selected</c:if>>보류</option>
					...
					<div class="card-body">
		                  ...
		                  <div class="table-responsive">
		                    <table id="notice" class="table table-striped table-bordered table-sm">
		                      <thead>
		                        <tr>
		                            <th width="*%" align="center" style="font-size: 13px; padding:15px 10px; text-align:center;" class="bg-light">관리일지</th>
		                            <th width="10%" align="center" style="font-size: 13px; padding:15px 10px; text-align:center;" class="bg-light">작성자</th>
		                            <th width="10%" align="center" style="font-size: 13px; padding:15px 10px; text-align:center;" class="bg-light">작성일</th>
		                        </tr>
		                      </thead>
		                      <tbody>
							  	<c:forEach items="${resultDiary}" var="list">
							  	  <tr>
