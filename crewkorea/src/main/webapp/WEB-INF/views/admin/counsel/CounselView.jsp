    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <input type="hidden" name="reurl" value="/manager/counsel/list.do"/>
              ...
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">상담정보입력</h4>
                    ...
                    <a href="/manager/counsel/list.do" class="btn btn-light">취소</a>
                </div>
              </div>
            </div>
          </div>
...
<script>
	...
	function deleteRow(idx){
		if(confirm("정말로 삭제하시겠습니까?") == true){
			location.href="/manager/counsel/delupdate.do?reurl=/manager/counsel/list.do&idx="+idx;	
		}else{
			return;
		}		
	}
