...
public class HumanResourceController {
	...
	@RequestMapping(value="/ehr/propose.do", method=RequestMethod.GET)
	...
	@RequestMapping(value="/ehr/submit.do")
	...
	@RequestMapping(value="/ehr/update.do", method=RequestMethod.POST)
	...
	@RequestMapping(value="/ehr/complete.do")
	public String complete (HttpServletRequest request) throws Exception {
		return "/ehr/complete";
	}
	
	@RequestMapping(value="/ehr/search.do")
	...
	@RequestMapping(value="/ehr/choice1st.do", method=RequestMethod.GET)
	...
	@RequestMapping(value="/ehr/choice2nd.do", method=RequestMethod.GET)
