...
<title>Онлайнаар ажилд авах өргөдөл гаргана</title>
...
<div class="container-fluid">
	<div class="row sm-row site-map-row my-4">
		<div class="col-12 py-4 text-center">
			<div class="font-26 mb-1" id="mobile-100-percent">Онлайнаар ажилд авах өргөдөл гаргана</div>
...
<div class="container-fluid">
	<div class="row sm-row">
		<div class="col-12 card bg-ivory">
			<div class="card-body">
				<ul>
					<li class="float-left mt-1 font-18">Ажилд авах зар<span class="font-18 mx-3">:</span>${param.title}</li>
				</ul>
			</div>
		</div>
	</div>
...
<div class="container-fluid">
	<div class="row sm-row">
		...
		<!-- 개인프로필입력 시작 -->
		<div class="col-12 mt-4 mb-2 font-bold font-20">Хувийн профайл</div>
		<div class="col-6 my-2" id="mobile-100-percent">
			<div class="card">
				<div class="card-body">
					<div class="form-group">
						<label for="photo" class="font-14">Зураг хавсаргана уу (Зөвхөн JPG эсвэл PNG файлуудыг хүлээн авна.)</label>
						<div class="text-center mx-5">
               				<img src="/admin/images/photo-sample.jpg" class="wrapper-tn" id="wrapper-tn" width="67%">
               			</div>
               			<div class="my-3 text-center">
               				<input type="file" name="photo" id="photo" style="display:none;">
               				<button type="button" class="btn mx-2 btn-primary" id="upload-tn">Upload</button>
               				<button type="button" class="btn mx-2 btn-danger" id="init-tn" onclick="deleteImageAction()">Delete</button>
               			</div>
						<div class="help-block with-errors text-danger"></div>
					</div>
				</div>
		...
		<div class="col-6 col-padding my-2" id="mobile-100-percent">
			<div class="card col-md-12 bg-ke">
				<div class="card-body">
					<div class="form-group">
						<label for="korname" class="form-label font-bold">Нэр</label>
						<div class="input-group">
							<input type="text" class="form-control" name="korname" id="korname" placeholder="Нэр" required>
						</div>
						<div class="help-block with-errors text-danger"></div>
					</div>
					<div class="form-group">
						<label for="engname" class="font-bold">Англи нэр(Том үсгээр оруулна уу)</label>
						<div class="input-group">
							<input type="text" class="form-control" name="engname" id="engname" placeholder="예 : FIRST NAME, LAST NAME" required>
						</div>
						<div class="help-block with-errors text-danger"></div>
					</div>
					<div class="form-group">
						<label for="phoneagency" class="font-bold">Утасны дугаар</label>
						<div class="input-group">
							<input type="number" class="form-control input-group-append mr-2" oninput="maxLengthCheck(this)" name="srhphoneagency" id="srhphoneagency" maxlength="4" placeholder="010" required>
							<input type="number" class="form-control input-group-append mr-2" oninput="maxLengthCheck(this)" name="phonefirst" id="phonefirst" maxlength="4" placeholder="1234" required>
							<input type="number" class="form-control input-group-append" oninput="maxLengthCheck(this)" name="phonesecond" id="phonesecond" maxlength="4" placeholder="1234" required>
						</div>
						<div class="help-block with-errors text-danger"></div>
					</div>
					<div class="form-group">
						<label for="engname" class="font-bold">Имэйл</label>
						<div class="input-group">
		...
		<div class="col-12 my-2">
			<div class="col-12 my-2 font-bold font-20">Resume файлыг бүртгүүлнэ үү</div>
			<div class="card my-2 col-12 bg-ke">
				<div class="card-body">
					<div class="form-group">
						<label for="input-gender">Файлын бүртгэл</label>
						<div class="input-group">
		...
		<!-- 상세정보입력 시작 -->
		<div class="col-12 my-2">
			<div class="col-12 my-2 font-bold font-20">Нарийвчилсан мэдээлэл</div>
			<div class="card my-2 col-12 bg-ke">
				<div class="card-body">
					<div class="form-group">
						<label for="input-gender">Төрсөн жил</label>
						<div class="input-group">
							<input type="number" class="form-control input-group-append mr-2" oninput="maxLengthCheck(this)" name="birthyear" id="birthyear" maxlength="4" placeholder="Төрсөн он" required>
							<input type="number" class="form-control input-group-append mr-2" oninput="maxLengthCheck(this)" name="birthmonth" id="birthmonth" maxlength="2" placeholder="Төрсөн сар" required>
							<input type="number" class="form-control input-group-append" oninput="maxLengthCheck(this)" name="birthday" id="birthday" maxlength="2" placeholder="Төрсөн өдөр" required>
						</div>
						<div class="help-block with-errors text-danger"></div>
					</div>
					<div class="form-group">
						<label for="input-gender">Өндөр / Нас</label>
						<div class="input-group">
							<input type="number" class="form-control input-group-append mr-2" oninput="maxLengthCheck(this)" name="height" id="height" maxlength="3" placeholder="161cm" required>
							...
							<input type="number" class="form-control input-group-append mr-2" oninput="maxLengthCheck(this)" name="age" id="age" maxlength="2" placeholder="Нас" required>
						</div>
						<div class="help-block with-errors text-danger"></div>
					</div>
					<div class="form-group">
						<label for="gender">Хүйс / Харьяат</label>
						<div class="input-group">
							<select class="form-control mr-2" id="gender" name="gender" style="height:3.75rem;" required>
								<option value="эмэгтэй">Эмэгтэй</option>
								<option value="Эрэгтэй">Эрэгтэй</option>
							</select>
							<input type="text" class="form-control input-group-append" name="nation" id="nation" maxlength="30" placeholder="Жишээ нь : Монгол" required>
						</div>
					</div>
					<div class="form-group">
						<label for="edulv">бүс нутаг</label>
						<div class="input-group">
						<input type="text" class="form-control" name="address" id="address" style="height:3.75rem;" placeholder="Жишээ нь : Уламбатар" required>
						</div>
					</div> 
					<div class="form-group">
						<label for="edulv">Боловсрол</label>
						<div class="input-group">
						...
						<select class="form-control input-group-append mr-2" name="edugb" id="edugb" style="height:3.75rem;" required>
							<option value="Ахлах сургууль" selected>Ахлах сургууль</option>
							<option value="2бага коллеж">2бага коллеж</option>
							<option value="Их сургууль">Их сургууль</option>
							<option value="Төгсөлтийн сургууль">Төгсөлтийн сургууль</option>
						</select>
						<select class="form-control input-group-append" name="gradlv" id="gradlv" style="height:3.75rem;" required>
							<option value="Төгссөн" selected>Төгссөн</option>
							<option value="Төгсөх төлөвтэй байна" >Төгсөх төлөвтэй байна</option>
						</select>
						</div>
					</div>
					<div class="form-group">
						<label for="langlv">Хэлний оноо(Англи)</label>                      
						<div class="input-group">
							<input type="text" class="form-control " name="langlv1" id="langlv1" maxlength="50"  placeholder="EX : TOEIC 850, TOEIC SPEAKING Level 6" required>  
						</div>
					</div>
					<div class="form-group">
						<label for="langlv">Хэлний оноо(Бусад гадаад хэл)</label>                      
						<div class="input-group">
							<input type="text" class="form-control " name="langlv2" id="langlv2" maxlength="50"  placeholder="EX : CHINESE HSK Level 6, JAPANESE JLPT Level 1" required>  
						</div>
					</div>
					<div class="form-group">
						<label for="introduce">Холбогдох ажлын туршлага(Жилийн тоог оруулна уу)</label>                      
						<div class="input-group">
							<input type="text" class="form-control input-group-append col-md-4 mr-2" name="referyear" id="referyear" placeholder="EX : 3 жилийн хугацаа" maxlength="20">
							<input type="text" class="form-control" name="reference" id="reference" maxlength="50"  placeholder="Role(Англи хэлээр оруулна уу)">							
						</div>
						<div class="help-block with-errors text-danger"></div>
					</div> 
					<!-- div class="form-group">
			...
			<div class="form-group">
                <div class="custom-control custom-checkbox">
		    		<input type="checkbox" name="bt_agree" value="1" id="bt_agree" class="custom-control-input" checked>
		     		<label for="agree" class="custom-control-label">Би нууцлалын бодлогыг зөвшөөрч байна. <span class="mx-2"></label>
            	</div>
            </div>
			<div class="col-10 pr-2">
				<button type="submit" id="gopropose" class="btn btn-primary btn-lg btn-block" style="height:4.00rem;">Илгээх</button>
				<p class="mt-1 ml-2 font-red">Өргөдөл гаргасны дараа та зөвхөн ажил зарлах эцсийн хугацаа дуусахаас өмнө өргөдлөө засах боломжтой..</p>
			</div>
			<div class="col-2">
				<button type="button" id="goback" class="btn btn-danger btn-lg btn-block" style="height:4.00rem;">цуцлах</button>
			</div>
		</div>
