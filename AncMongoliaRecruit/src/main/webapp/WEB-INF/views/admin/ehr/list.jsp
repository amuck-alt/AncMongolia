              ...
              <div class="d-flex justify-content-between flex-wrap">
                <div class="d-flex align-items-end flex-wrap">
                  <div class="mr-md-3 mr-xl-5">
                    <h3 class="under-line mx-1">채용공고관리@</h3>
                  </div>
                </div>
                      ...
                      <tbody>
                        <c:forEach items="${recruit}" var="list">
	                        ...
	                        <tr>
	                            ...
	                            <td><a href="/manager/ehr/view.do?idx=${list.idx}">${list.title}</a></td>
	                            <td align="center">${startDayTime}시&nbsp;~&nbsp;${endDayTime}시&nbsp;</td>
	                            <td align="center">
	                            	<c:choose>
	                            		<c:when test="${thisDayTime >= endDayTime}">마감</c:when>
	                            		<c:when test="${thisDayTime <= startDayTime}">대기</c:when>
...
<script>
 	...
 	function goWrite(){
 		document.location.href="/manager/ehr/write.do";
 	}
