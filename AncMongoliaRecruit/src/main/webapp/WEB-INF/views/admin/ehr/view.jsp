              ...
              <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
	                      <div class="mb-2">
	               			<span>기존&nbsp;:&nbsp;</span><a href="/data/download.do?filepath=${result.filepath}&filename=${result.filename}">${result.filename}</a>
	               		  </div>
	               	  </div>
	               	  <div class="input-group">
	                      <span class="">변경&nbsp;:&nbsp;</span><input type="file" class="form-control" name="resume" id="resume" placeholder="지원서양식첨부">
	                      <div class="help-block with-errors text-danger"></div>
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <a href="/manager/ehr/list.do" class="btn btn-light">취소</a>
                </div>
              </div>
            </div>
          </div>	
...
<script>
	...
	function deleteRow(idx){
		if(confirm("정말로 삭제하시겠습니까?") == true){
			location.href="/manager/ehr/delete.do?idx="+idx;	
		}else{
			return;
		}		
	}
