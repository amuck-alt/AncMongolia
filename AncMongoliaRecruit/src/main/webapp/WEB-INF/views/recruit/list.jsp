...
<div class="container-fluid">
	<div class="row sm-row site-map-row my-5">
		<div class="col-12 py-4 text-center">
			<div class="font-26 mb-1" id="mobile-100-percent">Ажилд авах дэмжлэг</div>
		...
		<div class="col-12 my-2">
				...
				<c:forEach items="${result}" var="list" >
					<ul class="col-12 align-middle line-1-gray">
						<li class="col-6 px-2 py-3 mobile-100-percent">
						...
						<li class="col-6 px-2 py-3 mobile-100-percent">
						  ...
						  <p class="font-14 font-gray my-3">${list.description }</p>
						  <p class="font-14 my-3">${list.stdaytime } ~ ${list.enddaytime }
							  <c:choose>
								<c:when test="${thisDayTime <= list.stdaytime}"><span class="ml-4 tiny-label bg-pink">waiting</span></c:when>
		                        <c:when test="${thisDayTime >= list.enddaytime}"><span class="ml-4 tiny-label bg-navy">end</span></c:when>
		                        <c:otherwise><span class="ml-2 tiny-label bg-pink">in progress</span></c:otherwise>
		                      </c:choose>
						  </p>				  
						</li> 
					</ul>
