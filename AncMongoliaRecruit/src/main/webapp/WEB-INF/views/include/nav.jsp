	...
	<div class="head-row">
		<div class="col-4 align-middle">
			<div class="logo" style="padding-top: 18px;">
				<a href="/"><img src="/images/anc-mongolia.png"></a>
			</div>
		</div>
		<div class="col-8 text-right">
			<div class="campus py-2 line-1-gray">
				<ul>
					<li><a href="https://www.crew-factory.com" target="_blank">Anc Нислэгийн үйлчлэгчийн академи</a></li>
			...
			<div class="outlink py-2">
				<ul>
					<li style="width: 430px;">
						<div class="col-4">
							<label class="sm-label font-10">Хуваарийг эхлүүлэх</label>
						</div>
...
<nav class="container-fluid line-1-gray mobile-hidden">
	<div class="row sub-row" style="text-align:center;">
		<ul class="col-10 gnb-menu" id="gnb-menu" style="height:45px;">
			<li class="font-16"><a href="/recruit/list.do" class=""><b>Ажилд авах дэмжлэг</b></a><label class="ml-2 hot-dot"></label></li>
			<li class="font-16"><a href="/ehr/search.do" class=""><b>Дэмжлэгийн статус</b></a><label class="ml-2 hot-dot"></label></li>
			<li class="font-16"><a href="/counsel/online.do" class=""><b>Зөвлөх</b></a></li>
			<li class="font-16"><a href="/news/list.do" class=""><b>Мэдэгдэл</b></a></li>
			<li class="font-16"><a href="/introduce/intro.do" class=""><b>ANC танилцуулга</b></a></li>
		</ul>
	</div>
</nav>
...
<div class="container border-bottom mobile-show">
	<div class="row">
		<div class="col-12 px-2 py-3">
			...
			<div class="col-8 text-center"><a href="/"><img src="/images/anc-mongolia.png" width="164px"></a></div>
		</div>
	</div>
</div>
