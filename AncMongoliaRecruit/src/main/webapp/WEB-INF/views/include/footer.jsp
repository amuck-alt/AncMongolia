...
<div class="container-fluid bg-navy">
  <div class="row main-row">
    <div class="col-12 py-5" id="footer-outlink">
      <div class="col-4">
        <img src="/images/anc-mongolia_w.png">
        <div class="mt-2">
          <ul>
      	  	<li class="float-left px-3"><a href="https://www.facebook.com/crewseoul" target="_blank"><img src="/images/sns-facebook-ico.png"></a></li>
		  	<li class="float-left px-3"><a href="https://www.instagram.com/crewfactory_fly/" target="_blank"><img src="/images/sns-instagram-ico.png"></a></li>
		  	<li class="float-left px-3"><a href="https://pf.kakao.com/_QWAEl" target="_blank"><img src="/images/sns-kakao-ico.png"></a></li>
		  </ul>
        </div>
      </div>
      <div class="col-8">
        <ul class="col-12">
        	<li class="float-left col-2 px-3 py-2 mobile-100-percent font-white">Үндсэн утас</li>
        	<li class="float-left col-10 px-3 py-2 mobile-100-percent font-white">XXX-XXX-XXXX</li>
        </ul>
        <ul class="col-12">
        	<li class="float-left col-2 px-3 py-2 mobile-100-percent font-white">Хаяг</li>
        	<li class="float-left col-10 px-3 py-2 mobile-100-percent font-white">XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX</li>
        </ul>
        <div class="col-12 px-3 py-2 font-white">Copyright ⓒ Airline NetWork Center, All rights reserved.</div>
      </div>
    </div>
  </div>
</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="col-12 px-3" style="overflow: auto; width: 100%; height: 500px;">
					...
					<br>
					<p class="mx-2">
						원칙적으로 ㈜ 에어라인네트워크센터 ANC승무원평생교육원 이용자의 개인정보를 타인 또는 타기업, 기관에 공개하지 않습니다.<br> 다만 아래의 경우에는 예외로 합니다.<br> ㈜ 에어라인네트워크센터 ANC승무원평생교육원을 통해 교육 도중 작성된 저작물에 대한 저작권 및 초상권 또는 컨텐츠(사진,동영상)는 합리적인 차원에서 ㈜백아에 귀속하여 활용할 수 있다.<br> 본인은 본인의 개인정보(이름, 생년월일, 전화번호, 이메일 등)를 ㈜ 에어라인네트워크센터 ANC승무원평생교육원에 제공하여 취업관련 서비스의 마케팅 활동(전화 통화 방식, 이메일 발송 방식, SMS방식 포함) 목적으로 제공, 활용되도록 함에 동의
						합니다.<br>
					</p>
				</div>
			</div>
