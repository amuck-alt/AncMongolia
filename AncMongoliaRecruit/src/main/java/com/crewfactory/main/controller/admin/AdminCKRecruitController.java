...
public class AdminCKRecruitController {
	...
	@RequestMapping(value="/manager/ehr/list.do")
	public String selectAdmin (Model model) throws Exception {
		model.addAttribute("recruit", service.selectAdmin() );
		return "/admin/ehr/list";
	}
	
	@RequestMapping(value="/manager/ehr/write.do")
	public String write () throws Exception {
		return "/admin/ehr/write";
	}
	
	@RequestMapping(value="/manager/ehr/insert.do", method=RequestMethod.POST)
	public String insert (HttpServletRequest request, @RequestParam("thumbnail") MultipartFile mpf, @RequestParam("resume") MultipartFile rsm, Model model) throws Exception {
		...
		return "redirect:/manager/ehr/list.do";
	}
	
	@RequestMapping(value="/manager/ehr/update.do", method=RequestMethod.POST)
	...
	@RequestMapping(value="/manager/ehr/view.do", method=RequestMethod.GET)
	public String view(@RequestParam(value="idx") int idx, Model model) throws Exception {
		model.addAttribute("result", service.view(idx));
		return "/admin/ehr/view";
	}
	
	@RequestMapping(value="/manager/ehr/delete.do", method=RequestMethod.GET)
