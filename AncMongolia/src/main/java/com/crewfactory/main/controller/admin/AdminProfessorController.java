...
public class AdminProfessorController {
	...
	@GetMapping("manager/pro/write.do")
	public String write (Model model) throws Exception {
		return "admin/pro/ProWrite";
	}
	
	@PostMapping("/manager/pro/insert.do")
	...
	@PostMapping("manager/pro/update.do")
	...
	@GetMapping("manager/pro/delete.do")
