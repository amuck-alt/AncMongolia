...
<div class="container-fluid intro-banner-corw-container">
	<div class="row cf-row pad-top-100">
		<div class="col-12">
			<h4 class="font-white">Partnership</h4>
			<div class="line-2-white my-3" style="width:200px;"></div>
			<h1 class="font-white">Түншлэл</h1>
			<h5 class="font-yellow mt-3">"Хэрэв та ANC-ийн оюутан болвол манай харьяа байгууллагуудаас янз бүрийн тэтгэмж авах боломжтой."</h5>
		</div>
	</div>
</div>
	...
	<div class="container-fluid">
		<div class="row cf-row">
			<div class="col-12" style="margin-top: 80px;" id="page1">
				<h2 class="float-left font-bold">제휴항공사</h2>
			...
			<div class="col-12" style="margin-bottom: 80px;">
				...
				<div style="float: left; display: inline; margin-right: 10px; margin-top: 8px;" id="mobile-45-percent">
					<img src="../img/corw-img-1-035.png">
				</div>
				<div style="float: left; display: inline; margin-right: 10px; margin-top: 8px;" id="mobile-45-percent">
					<img src="../img/corw-img-1-037.png">
				</div>
				<div class="col-12 my-3 line-1-gray"></div>
			</div>
