    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
		  ...
		  <form action="/manager/recruit/insert.do" name="form" id="form" method="post" data-toggle="validator" enctype="multipart/form-data">          
              ...
              <div class="card">
                <div class="card-body">
                    <div class="form-group">
                      <label for="section">Recruit Period</label>
...
<!--                         <select class="form-control ml-2" name="resumeyn" id="resumeyn">
                    ...
                    <div class="form-group">
               			...
               			<div>
               				<img src="/admin/img/no-image.png" class="wrapper-tn" id="wrapper-tn" width="100%">
               			</div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" value="" name="title" id="title" placeholder="Title" data-error="제목을 입력하세요." required>
                      <div class="help-block with-errors text-danger"></div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <label for="description" class="control-label">Resume</label>
