              ...
              <div class="d-flex justify-content-between flex-wrap">
                <div class="d-flex align-items-end flex-wrap">
                  <div class="mr-md-3 mr-xl-5">
                    <h3 class="under-line mx-1">Announce Management@</h3>
                  </div>
                </div>
                  ...
                  <div class="table-responsive">
                    <table id="notice" class="table table-striped table-bordered" style="width:100%;">
                      ...
                      <tbody>
                        ...
                        <tr>
                            <td width="10%" class="pt-3 font-18 font-bold">
							  <c:choose>
                            ...
                            <td><a href="/manager/announce/view.do?idx=${list.idx}">${list.title}</a></td>
                            <td>${list.visit}</td>
...
<script>
 	...
 	function goWrite(){
 		document.location.href="/manager/announce/write.do";
 	}
