    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
		  ...
		  <form action="/manager/moment/insert.do" name="blog" method="post" data-toggle="validator" enctype="multipart/form-data">          
                ...
                <div class="card-body">
                    <div class="row">
	                  ...
	                  <div class="col-12 form-group">  
						...
						<a href="/manager/auth/Auth.do" class="btn btn-light">Cancel</a>
	                  </div>
	                </div><!-- end row -->
				</div><!-- end card body -->
              </div><!-- end card -->
