...
import com.crewfactory.main.service.MovieService;
...
public class AdminMovieController {
	...
	@RequestMapping(value="/manager/blog/Movie.do", method=RequestMethod.GET)
	public String init(Model model) throws Exception {
		model.addAttribute("result", service.select());
		return "/admin/blog/MovieList";
	}
	
	@RequestMapping(value="/manager/blog/MovieWrite.do", method=RequestMethod.GET)
	public String write(Model model) throws Exception {
		return "/admin/blog/MovieWrite";
	}
	

	@RequestMapping("/manager/blog/MovieInsert.do") 
	String insert(HttpServletRequest request, @RequestParam("thumbnail") MultipartFile mpf, Model model) throws Exception {
		...
		return "redirect:/manager/blog/Movie.do";
	}
	
	@RequestMapping(value="/manager/blog/MovieView.do", method=RequestMethod.GET)
	public String view(@RequestParam(value="idx") int idx, Model model) throws Exception {
		model.addAttribute("result", service.view(idx) );
		return "/admin/blog/MovieView";
	}
	
	@RequestMapping("/manager/blog/MovieUpdate.do")
	...
	@RequestMapping(value="/manager/blog/MovieDelete.do", method=RequestMethod.GET)
