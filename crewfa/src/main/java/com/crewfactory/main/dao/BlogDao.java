...
public interface BlogDao {
	...
	public List <BlogDomain> selectWaveByWeb (Map<String, Object> paramMap) throws Exception;
	public List <BlogDomain> selectMomentByWebIncheon (Map<String, Object> paramMap) throws Exception;
